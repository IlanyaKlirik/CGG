...
def func1(x, y):
    # return abs(math.sin(math.cos(x * y)))
    # return x**3 - 3*x + y**2
    return -math.cos(x*y)
...
class Graph(QWidget):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle('График функции. 3D')
        self.show()
    ...
    """
    Исходя из заданных диапазонов расчита
    """
...
"""
Прямоугольная изометричная проекция
Экранные координаты для x и y получаем методами ниже
"""
